...
TARGETS = {
    ...
    'RUUP01v0': ("Animal Crossing: Let's Go to the City (Europe, Rev 0)",
                 os.path.join(paths.SRC_IMAGES, 'RUUP01r0/sys/main.dol'), -724, 'RUUP01', 0),
    'RUUP01v1': ("Animal Crossing: Let's Go to the City (Europe, Rev 1)",
                 os.path.join(paths.SRC_IMAGES, 'RUUP01r1/sys/main.dol'), -432, 'RUUP01', 1),
